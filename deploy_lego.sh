...
APP_DIR="/Users/pierrepoignant/Coding/lego"
KUBE_DIR="/Users/pierrepoignant/Coding/kubernetes"
IMAGE="8ie06lx5.c1.gra9.container-registry.ovh.net/lego/lego-apps:latest"
...
kubectl delete deployment lego-apps -n "$NAMESPACE" --ignore-not-found
...
wait_for_deployment "lego-apps" "lego-apps"
...
echo ""
echo "🚀 Pods:"
kubectl get pods -n "$NAMESPACE" -l app=lego-apps
echo ""
echo "💡 Access your apps:"
echo "   - Streamlit Dashboard: Port 8501"
echo "   - Flask Admin: Port 5003"
